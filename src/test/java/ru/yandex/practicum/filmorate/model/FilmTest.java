...
class FilmTest {
    ...
    public void testBlankName() {
        final Film film = new Film("", "description", LocalDate.now(), 120);
    ...
    public void testBlankDescription() {
        final Film film = new Film("name", "", LocalDate.now(), 120);
    ...
    public void testLongDescription() {
        ...
        final Film film = new Film("name", description, LocalDate.now(), 120);
    ...
    public void testDuration() {
        final Film film = new Film("name", "description", LocalDate.now(), -1);
